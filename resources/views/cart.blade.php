                            ...
                            @foreach(Cart::content() as $cart)
                              <tr class="cart_item">
                                  ...
                                  <td class="product-price">
                                      <h5 class="price amount">Rs. {{ $cart->price }}</h5>
                                  </td>
                                  ...
                                  <td class="product-quantity">
                                      ...
                                      <div class="quantity">
                                          ...
                                          <input title="Qty" class="email input-text qty text" type="text" value="{{ $cart->qty }}" readonly>
                                  ...
                                  <td class="product-subtotal">
                                      <h5 class="total amount">Rs. {{ $cart->total() }}</h5>
                                  </td>
